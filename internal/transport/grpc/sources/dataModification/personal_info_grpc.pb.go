...
func (c *personalInfoClient) GetReasonOfAbsence(ctx context.Context, in *ContactDetails, opts ...grpc.CallOption) (*ContactDetails, error) {
	...
	err := c.cc.Invoke(ctx, "/dataModification.PersonalInfo/getReasonOfAbsence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnsafePersonalInfoServer may be embedded to opt out of forward compatibility for this service.
...
func _PersonalInfo_GetReasonOfAbsence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dataModification.PersonalInfo/getReasonOfAbsence",
	}
...
// PersonalInfo_ServiceDesc is the grpc.ServiceDesc for PersonalInfo service.
